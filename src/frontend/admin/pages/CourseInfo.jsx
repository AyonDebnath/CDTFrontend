...
import CourseInfoTable from "../features/course-center/courseInfoTable";
    ...
    const fetchData = async () => {
      try {
        const responseData = await sendRequest(
          `${import.meta.env.VITE_SERVER_NAME}api/admin/course/all`
        );
            ...
            <div className="col-xxl-12">
              <div className="card" id="companyList">
                ...
                <div className="card-body">
                  <div>
                    <CourseInfoTable courseData={courseData} />
                  </div>
                </div>
                {/* <!--end card--> */}
              </div>
