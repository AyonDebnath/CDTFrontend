...
export default function AdminDelete({ curAdmin }) {
  const del = useContext(AdminDeleteContext);
  ...
  const handleSubmit = async (event) => {
    ...
    if (formState.inputs.name.value === curAdmin.name) {
      try {
        await sendRequest(
          `${import.meta.env.VITE_SERVER_NAME}api/admin/admin/delete/${
            curAdmin.id
          }`,
          "DELETE",
          null,
        ...
        {curAdmin && (
          <div className="container">
            <div className="d-flex justify-content-center">
              ...
              >
                <Label>
                  Enter the admin name <strong>{curAdmin.name}</strong> to
                  delete the admin
                </Label>
